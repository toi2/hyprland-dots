...
hl.bind("SUPER + Minus", hl.dsp.window.resize({ x = -10, y = 0 }), { repeating = true })
hl.bind("SUPER + Equal", hl.dsp.window.resize({ x = 10, y = 0 }), { repeating = true })
hl.bind("SUPER + SHIFT + Minus", hl.dsp.window.resize({ x = 0, y = -10 }), { repeating = true })
hl.bind("SUPER + SHIFT + Equal", hl.dsp.window.resize({ x = 0, y = 10 }), { repeating = true })
hl.bind("SUPER + ALT + left", hl.dsp.window.resize({ x = -10, y = 0 }), { repeating = true })
hl.bind("SUPER + ALT + right", hl.dsp.window.resize({ x = 10, y = 0 }), { repeating = true })
hl.bind("SUPER + ALT + up", hl.dsp.window.resize({ x = 0, y = -10 }), { repeating = true })
hl.bind("SUPER + ALT + down", hl.dsp.window.resize({ x = 0, y = 10 }), { repeating = true })
...
-- Dark-themed selection: Translucent dark background with a deep blue/gray border
